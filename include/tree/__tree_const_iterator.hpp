#ifndef __TREE_CONST_ITERATOR_HPP
#define __TREE_CONST_ITERATOR_HPP
...
public:
    ...
    __tree_const_iterator& operator++()
    {
        __ptr_ = static_cast<__iter_pointer>(
            __tree_next_iter<__end_node_pointer>(
    ...
    {
        __ptr_ = static_cast<__iter_pointer>(
            __tree_prev_iter<__node_base_pointer>(
...
#endif // __TREE_CONST_ITERATOR_HPP
